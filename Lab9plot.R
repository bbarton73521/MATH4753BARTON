...
#'
#' @return a plot and list of simulation statistics
#' @export
#'
#' @examples \dontrun {myboot2(n=10,x=rnorm(30),fun="mean",alpha=.05,iter=10000)}
myboot2=function(n,x,fun,alpha,iter,...){
